      ...
      <div className="relative overflow-hidden min-h-screen flex items-center px-6">
        ...
        <div className="mx-auto max-w-5xl mb-32">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-[#000] sm:text-7xl">
              Your Intelligent Medical Assistant.
            </h1>

            <p className="mt-8 text-lg font-medium text-gray-400 sm:text-xl">
              MedChat AI helps you understand symptoms, get medical insights, and access health information instantly using advanced AI.
            </p>
